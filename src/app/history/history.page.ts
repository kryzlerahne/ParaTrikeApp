...
export class HistoryPage implements OnInit {
  ...
  rides: any[] = [
    ...
    {id: 3, validation: 'Cancelled', refCode: '0000014', amount: -30.00,  date: 'July 25, 2022', time: '7:30AM'},
  ];

  lastRides: any[] = [
    {id: 1, validation: 'Cancelled', refCode: '0000015', amount: -30.00, date: 'June 30, 2022',time: '5:00PM'},
    {id: 2, validation: 'Driver Felip #0143', refCode: '0000016', amount: 80.00,  date:' June 21, 2022', time: '11:00AM'},
    {id: 3, validation: 'Cancelled', refCode: '0000017', amount: -30.00,  date:' June 17, 2022', time: '8:00PM'},
  ];
